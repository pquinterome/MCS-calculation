...
model2.fit(train_generator, validation_data= test_generator, callbacks=[early_stop] ,epochs=400, verbose=0)
...
fig = plt.figure(4)
plt.scatter(x=y_test, y=pred2, edgecolors='k', color='g', alpha=0.7)

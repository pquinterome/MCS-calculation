...
x = Conv1D(filters=70, kernel_size=(5), activation='relu', padding='same')(i)
...
pred = model1.predict(X_test2)
predictions = np.round(pred)
print(f'Accuracy{i}_0.01',   accuracy_score(y_test, predictions))
print(f'precision{i}_0.01',  precision_score(y_test, predictions))
print(f'recall{i}_0.01',     recall_score(y_test, predictions))
print(f'f1{i}_0.01',         f1_score(y_test, predictions))
...
pred = model1.predict(X_test2)
predictions = np.round(pred)
print(f'Accuracy{i}_0.02',   accuracy_score(y_test, predictions))
print(f'precision{i}_0.02',  precision_score(y_test, predictions))
print(f'recall{i}_0.02',     recall_score(y_test, predictions))
print(f'f1{i}_0.02',         f1_score(y_test, predictions))
tn, fp, fn, tp = confusion_matrix(y_test, predictions).ravel()
specificity = tn / (tn+fp)

specificity
print(f'Specificity1{i}_0.02',   specificity)
model2.compile(loss='mean_squared_error', optimizer='adam', metrics=['mean_absolute_error'])
model2.fit(x= X_train2, y =y_train2, validation_data= (X_test2, y_test2), callbacks=[reduce_lr] ,epochs=400, verbose=0)
pred2 = model2.predict(X_test2)
mae = mean_absolute_error(y_test2, pred2)
...
pred = model1.predict(X_test2)
predictions = np.round(pred)
print(f'Accuracy{i}_0.03',   accuracy_score(y_test, predictions))
print(f'precision{i}_0.03',  precision_score(y_test, predictions))
print(f'recall{i}_0.03',     recall_score(y_test, predictions))
print(f'f1{i}_0.03',         f1_score(y_test, predictions))
tn, fp, fn, tp = confusion_matrix(y_test, predictions).ravel()
specificity = tn / (tn+fp)

specificity
print(f'Specificity1{i}_0.03',   specificity)
model2.compile(loss='mean_squared_error', optimizer='adam', metrics=['mean_absolute_error'])
model2.fit(x= X_train2, y =y_train2, validation_data= (X_test2, y_test2), callbacks=[reduce_lr] ,epochs=400, verbose=0)
pred2 = model2.predict(X_test2)
mae = mean_absolute_error(y_test2, pred2)
...
pred = model1.predict(X_test2)
predictions = np.round(pred)
print(f'Accuracy{i}_0.04',   accuracy_score(y_test, predictions))
print(f'precision{i}_0.04',  precision_score(y_test, predictions))
print(f'recall{i}_0.04',     recall_score(y_test, predictions))
print(f'f1{i}_0.04',         f1_score(y_test, predictions))
tn, fp, fn, tp = confusion_matrix(y_test, predictions).ravel()
specificity = tn / (tn+fp)

specificity
print(f'Specificity1{i}_0.04',   specificity)
model2.compile(loss='mean_squared_error', optimizer='adam', metrics=['mean_absolute_error'])
model2.fit(x= X_train2, y =y_train2, validation_data= (X_test2, y_test2), callbacks=[reduce_lr] ,epochs=400, verbose=0)
pred2 = model2.predict(X_test2)
mae = mean_absolute_error(y_test2, pred2)
...
pred = model1.predict(X_test2)
predictions = np.round(pred)
print(f'Accuracy{i}_0.05',   accuracy_score(y_test, predictions))
print(f'precision{i}_0.05',  precision_score(y_test, predictions))
print(f'recall{i}_0.05',     recall_score(y_test, predictions))
print(f'f1{i}_0.05',         f1_score(y_test, predictions))
tn, fp, fn, tp = confusion_matrix(y_test, predictions).ravel()
specificity = tn / (tn+fp)

specificity
print(f'Specificity1{i}_0.05',   specificity)
model2.compile(loss='mean_squared_error', optimizer='adam', metrics=['mean_absolute_error'])
model2.fit(x= X_train2, y =y_train2, validation_data= (X_test2, y_test2), callbacks=[reduce_lr] ,epochs=400, verbose=0)
pred2 = model2.predict(X_test2)
mae = mean_absolute_error(y_test2, pred2)

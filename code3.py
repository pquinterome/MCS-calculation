...
model1 = tf.keras.models.load_model('model/model_1.h5')
model2 = tf.keras.models.load_model('model/model_2.h5')
model3 = tf.keras.models.load_model('model/model_3.h5')

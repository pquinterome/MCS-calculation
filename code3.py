...
y1 = pd.read_csv('id_HL_3Gy_2ARC.csv')
y2 = pd.read_csv('id_HL_3Gy_1ARC.csv')
...
## compile model     
    ...
    r = model.fit(train_generator, epochs=3, validation_data=(X[test], y[test]), callbacks=[early_stop], verbose=0)

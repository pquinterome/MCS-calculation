...
for model in models:
    ...
    model4.fit(x=[X_train1, X_train2, X_train3], y= y_train2, validation_data= ([X_test1, X_test2, X_test3], y_test2), callbacks=[early_stop, reduce_lr], epochs=200, verbose=0)
